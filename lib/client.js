...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function createVoiceController() {
       ...
       * load there. Goes through the SAME audioQueue/activeSessionId gating
       * as request() so it obeys every invariant above (superseded by a
       * newer request, dropped if the session's been left by playback
       * time, ...) instead of being a special case.
       */
